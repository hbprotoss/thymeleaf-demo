 ...
 */
public class FooterElementTagProcessor extends AbstractElementTagProcessor {
    private static final String TAG_NAME = "footer";
    private static final int PRECEDENCE = 1000;

    public FooterElementTagProcessor(String dialectPrefix) {
        super(
    ...
    protected void doProcess(ITemplateContext context, IProcessableElementTag tag, IElementTagStructureHandler structureHandler) {
        ...
        String template;
        try {
            template = TemplateUtil.getTemplate("templates/footer.html", webCtx);
        } catch (IOException e) {
